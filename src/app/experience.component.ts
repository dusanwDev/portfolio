  ...
  experienceItems: ExperienceItem[] = [
    {
      ...
      description: [
        'Rewrote Angular web application in modern React using TypeScript, Zustand, Emotion and Zod',
        'Designed and implemented a white-label architecture, enabling deployment of customizable solutions for multiple clients',
        'Built a centralized library of reusable UI components with Storybook to reduce redundancy and maintain consistent UI standards',
        'Refactored Angular application using SOLID principles to improve readability and maintainability',
        'Performed Angular version upgrades from v4 to the latest stable releases',
        'Achieved a 90+ Lighthouse score (up from 50–60) by implementing OnPush change detection, lazy loading, and asset optimization',
        'Adjusted the entire codebase to adhere to WCAG accessibility standards',
        'Introduced XSS prevention measures by sanitizing dynamic content and eliminating unsafe DOM usage',
        'Ensured cross-browser compatibility and optimized application speed and performance',
        'Worked closely with designers to translate Figma designs into reusable components',
        'Collaborated with the backend team to refactor the authentication flow, migrating from token-based to secure cookie-based login',
        'Automated frontend deployment by implementing Dockerization and CI/CD pipelines, eliminating manual builds',
        'Supported QA in writing Cypress tests, increasing automated test coverage and reducing production bugs',
        'Delivered multiple Angular projects in parallel, maintaining code quality and meeting deadlines',
        'Worked in an agile team environment, participating in sprint planning, daily stand-ups, and retrospectives',
        'Onboarded new team members from non-JS backgrounds, conducting code reviews, knowledge transfer, and pair programming sessions',
        'Collaborated with Austrian colleagues from Post Business Solutions, using English as the main language',
      ]
    }
  ];
