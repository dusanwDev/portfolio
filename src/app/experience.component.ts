  ...
  experienceItems: ExperienceItem[] = [
    {
      ...
      description: [
        ...
        'Refactored Angular application using SOLID principles in order to improve better readability and maintainability',
        ...
        'Automated frontend deployment by implementing Dockerization and CI/CD pipelines thus removing manual build creation',
        ...
        'Collaborated successfully with Austrian colleagues from Post Business Solutions using English as the working language',
      ]
    }
  ];
